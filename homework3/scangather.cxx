...
/**** your code here ****/
  ...
  if (procno==0) {
    ...
    cout << "GB: " << gather_buffer.size() << " NE: " << total_number_of_elements << "\n";
  }
  /*
  ...
  MPI_Gatherv
    (my_elements.data(), my_number_of_elements, MPI_INT,
     gather_buffer.data(), size_buffer.data(), displ_buffer.data(), MPI_INT,
     0, comm
     );
  /*
